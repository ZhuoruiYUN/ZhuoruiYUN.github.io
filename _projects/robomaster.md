...
experience_role: Sentry Electrical Control Lead (2026); Electrical Control, Algorithms & Navigation Lead (2027)
...
<div class="row">
  <div class="col-md-4 mb-4">
    <img src="{{ '/assets/img/robomaster-robots.JPG' | relative_url }}" class="img-fluid rounded" alt="Kongfu Team RoboMaster robots during technical inspection">
    <p class="caption">The team's three competition robots during technical inspection.</p>
  </div>
  <div class="col-md-4 mb-4">
    <img src="{{ '/assets/img/robomaster-sentry-arena.jpg' | relative_url }}" class="img-fluid rounded" alt="RoboMaster sentry robot operating in the arena">
